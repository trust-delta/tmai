...
> **Canonical (日本語)**: [CONTRIBUTING.md](./CONTRIBUTING.md)
...
| Docs, landing page, screenshots | `README.md` / `README.en.md` / `CHANGELOG.md` / `assets/` (this repo) |
...
- `README.md` / `README.en.md` / `CHANGELOG.md` / `LICENSE` / `assets/` — landing / docs / media
