...
> **Canonical (日本語)**: [README.md](./README.md)
...
→ How tmai records the destination and arrival — and why *Aim*, not a spec: **[docs/aim.en.md](docs/aim.en.md)**.
...
`tmai` serves the bundled WebUI automatically — open the URL it prints. For WebUI development (Vite HMR against a `tmai` backend), see [`CONTRIBUTING.en.md`](CONTRIBUTING.en.md#local-development).
...
See [`CONTRIBUTING.en.md`](CONTRIBUTING.en.md) for the [local development setup](CONTRIBUTING.en.md#local-development) (Vite HMR + `tmai` backend), the bot PR recovery flow, and PR conventions. Security reports go through [`SECURITY.en.md`](SECURITY.en.md) (GitHub Private Vulnerability Reporting).
