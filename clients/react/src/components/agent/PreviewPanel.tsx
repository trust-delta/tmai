...
// xterm.js-backed PreviewPanel (#5). Renders the agent's PTY through a
// real terminal emulator. Live / Transcript tabs, mode toggle, queue
// badge, and a hidden IME input for CJK composition all carry over from
// the previous AnsiUp pipeline. The hidden input remains because xterm
// v5's IME path still drops mid-composition keystrokes on the Live
// preview surface; revisit if and when xterm-native IME stabilises.
    ...
    >
      ...
      >
        ...
        <div
          ...
          role="log"
          aria-label="Agent terminal preview"
