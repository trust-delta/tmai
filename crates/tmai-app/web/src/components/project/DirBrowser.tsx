    ...
    >
      ...
      >
        ...
        <div className="max-h-80 overflow-y-auto">
          {loading && (
            <div className="px-5 py-6 text-center text-xs text-zinc-600">Loading...</div>
          )}
          {error && (
            <div className="px-5 py-6 text-center text-xs text-red-400">{error}</div>
          )}
          ...
          {!loading &&
            ...
            entries.map((entry) => (
              ...
              >
                ...
                {entry.is_git && (
                  <span className="shrink-0 text-[9px] text-cyan-600">git</span>
                )}
              </button>
            ))}
        </div>
