...
export function SecurityPanel({ onClose }: SecurityPanelProps) {
  ...
  useEffect(() => {
    api.lastSecurityScan().then((result) => {
          ...
          <>
            ...
            <section>
              ...
              <p className="mt-2 text-[11px] text-zinc-600">
                ...
                {scanResult.scanned_projects.length} projects{" "}
                at {new Date(scanResult.scanned_at).toLocaleTimeString()}
              </p>
            </section>
                ...
                {scanResult.risks.map((risk, i) => (
                  ...
                  >
                    <div className="flex items-start gap-2">
                      <span className={`text-xs font-mono font-bold ${severityColor(risk.severity)}`}>
                        [{risk.rule_id}]
                      </span>
